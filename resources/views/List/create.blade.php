        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  @endif
                    <form method="post" id="list_form" action="{{ route('saveWatchList') }}">
                        @csrf
                        <div class="form-group">
                             <label>List Name</label>
                             <input type="text" class="form-control" name="list_name" placeholder="Enter your list Name here">
                          ...
                          @foreach($companies as $company)
                            <div class="col-md-6">
                              <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="company_id" name="company_id[]" value="{{ $company['id'] }}">
                                <label class="form-check-label" for="exampleCheck1">{{ $company['shortname']  }}</label>
                              </div>
                            </div>
                          @endforeach
